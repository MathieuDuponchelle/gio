...
pub trait InputStreamExt {
    ...
    #[cfg(any(feature = "v2_34", feature = "dox"))]
    fn read_bytes_async<'a, P: Into<Option<&'a Cancellable>>, Q: FnOnce(Result<glib::Bytes, Error>) + Send + 'static>(&self, count: usize, io_priority: i32, cancellable: P, callback: Q);

    fn set_pending(&self) -> Result<(), Error>;

    fn skip<'a, P: Into<Option<&'a Cancellable>>>(&self, count: usize, cancellable: P) -> Result<isize, Error>;

    fn skip_async<'a, P: Into<Option<&'a Cancellable>>, Q: FnOnce(Result<isize, Error>) + Send + 'static>(&self, count: usize, io_priority: i32, cancellable: P, callback: Q);
}
